...
?>
	<form method="post" action="index.php?action=register">
		<fieldset>
			...
			<input type="text" name="nickname" id="nickname" maxlength="15" required <?php if (isset($_POST['nickname'])) { echo "value=\"" . htmlspecialchars($_POST['nickname']) . "\"" ; } ?> />
			<br />

			<label for="email">Email : </label>
			<input type="email" name="email" id="email" maxlength="255" required <?php if (isset($_POST['email'])) { echo "value=\"" . htmlspecialchars($_POST['email']) . "\"" ; } ?> />
			<br />
			...
			<fieldset>
				...
				<input type="text" name="lastname" id="lastname" maxlength="25" required <?php if (isset($_POST['lastname'])) { echo "value=\"" . htmlspecialchars($_POST['lastname']) . "\"" ; } ?> />
				<br />
